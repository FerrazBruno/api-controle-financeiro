...
(against-background [(before :facts [(iniciar-servidor porta-padrao) (limpar)])
                    ...
                    (fact "O saldo eh 10 quando a ultima receita eh 10" :aceitacao
                          (http/post (endereco-para "/transacoes") (receita 10))
                          (json/parse-string (conteudo "/saldo") true) => {:saldo 10})


                    (fact "O saldo eh 1000 quando criarmos duas receitas de 2000 e uma despesa de 3000" :aceitacao
                    ...
                    (fact "Rejeita uma transacao com valor que nao eh um numero" :aceitacao
